...
<body class="bg-gray-900 flex items-center justify-center min-h-screen overflow-hidden">
    ...
    <div class="login-container glassmorphic p-10 rounded-2xl w-full max-w-lg tilt animate-cascade-in">
        <h2 class="text-3xl font-bold text-teal-400 text-center mb-2 form-element" style="animation-delay: 0.2s;">
            <span class="animate-typewriter inline-block">Welcome Back</span>
        </h2>
        <p class="text-gray-400 text-center mb-6 form-element" style="animation-delay: 0.3s;">Login to Bus Reservation System</p>
        ...
        <div class="text-center mt-6 form-element" style="animation-delay: 0.8s;">
            <p class="text-gray-400">Don't have an account?</p>
            <a href="register">
                <button class="mt-2 bg-indigo-500 hover:bg-indigo-600 text-white px-6 py-2 rounded-lg animate-subtle-glow">Register</button>
            </a>
        </div>
    </div>
